...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
    ...
    $files = array_map(function ($name) {
        ...
        return preg_match('@\.php$@', $file) && !in_array($file, array('home.php', 'coming-soon.php', 'sponsorship-temp.php', 'call-for-industrial-track-temp', 'program-schedule.php', 'info-camp-vldb-temp.php'));
    }));
    ?>
    <url>
        <loc>https://vldb.org/2025/</loc>
        <lastmod><?= date('c', filemtime(Root . '/pages/home.php')); ?></lastmod>
        <priority>1.00</priority>
    </url>
    <?php foreach ($files as $file) { ?>
        <url>
            <loc>https://vldb.org/2025/?<?= $file; ?></loc>
