<section class="program-schedule-demonstrations">
    <h1>VLDB 2025: Demonstrations</h1>
    ...
    <div class="schedule-no-wrap">
        <div class="schedule-multi-days" id="Demo_Group_A">
            <div class="schedule-head"><strong class="main-title">Demo Group A</strong></div>
        ...
        <div>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="1003">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Mohammed&nbsp;Al-Kateb</span>&nbsp;(Teradata Labs),
                    <span class="author">Sanjay&nbsp;Nair</span>&nbsp;(Teradata Labs), and
                    <span class="author">Mani&nbsp;Srivastava</span>&nbsp;(UCLA)
                </span>
            </p>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="1040">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Supun&nbsp;Nakandala</span>&nbsp;(University of California, San Diego), and
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="998">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Slava&nbsp;Novgorodov</span>&nbsp;(eBay Research), and
                    <span class="author">Kathy&nbsp;Razmadze</span>&nbsp;(Tel Aviv University)
                </span>
            </p>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="1019">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Yuval&nbsp;Moskovitch</span>&nbsp;(Tel Aviv University)
                </span>
            </p>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="1049">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Yinan&nbsp;Li</span>&nbsp;(Microsoft Research), and
                    <span class="author">Donald&nbsp;Kossmann</span>&nbsp;(Microsoft Research)
                </span>
            </p>
        ...
        <div class="schedule-multi-days" id="Demo_Group_B">
            <div class="schedule-head"><strong class="main-title">Demo Group B</strong></div>
            ...
            <div>
                ...
                <em class="schedule-time">14:00 &ndash; 15:30</em>
            </div>
        ...
        <div>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="995">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Arsala&nbsp;Bangash</span>&nbsp;(University of Toronto), and
                    <span class="author">Renée&nbsp;J.&nbsp;Miller</span>&nbsp;(Northeastern University)
                </span>
            </p>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="949">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Jiaxuan&nbsp;Su</span>&nbsp;(Harbin Institute of Technology),
                    <span class="author">Zijue&nbsp;Li</span>&nbsp;(Harbin Institute of Technology),
                    <span class="author">Jianzhong&nbsp;Li</span>&nbsp;(Harbin Institute of Technology), and
                    <span class="author">Hong&nbsp;Gao</span>&nbsp;(Harbin Institute of Technology)
                </span>
            </p>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="956">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Prithviraj&nbsp;Sen</span>&nbsp;(IBM Research - Almaden)
                </span>
            </p>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="999">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Ashit&nbsp;Gosalia</span>&nbsp;(Microsoft),
                    <span class="author">Subru&nbsp;Krishnan</span>&nbsp;(Microsoft), and
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="1008">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Bolin&nbsp;Ding</span>&nbsp;(Alibaba Group),
                    <span class="author">Jingren&nbsp;Zhou</span>&nbsp;(Alibaba Group),
                    <span class="author">Cheng&nbsp;Hong</span>&nbsp;(Alibaba Group), and
                    <span class="author">Zhicong&nbsp;Huang</span>&nbsp;(Alibaba Group)
                </span>
            </p>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="1046">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Isil&nbsp;Dillig</span>&nbsp;(UT Austin)
                </span>
            </p>
            ...
            <p class="schedule-item schedule-item-no-abstract" data-id="1087">
                ...
                <span class="schedule-item-people">
                    ...
                    <span class="author">Yueguo&nbsp;Chen</span>&nbsp;(Renmin University of China), and
...
<?php
define('PageTitle', "Program Schedule - Demonstrations");
define('PageDescription', "List of accepted demonstrations.");
?>
<script type="application/ld+json">
{
  ...
  "url": "https://vldb.org/2025/?program-schedule-demonstrations",
  ...
  "breadcrumb": {
    ...
    "itemListElement": [{
      ...
      "position": 5,
      "item": {
        "@id": "https://vldb.org/2025/?program-schedule-demonstrations",
        "name": "Demonstrations"
      }
    }]
  }
