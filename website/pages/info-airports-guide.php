<section class="info-airports-guide">
    <h1>VLDB 2025: Airports Guide</h1>

    <h4>Los Angeles International Airport (LAX)</h4>

    <p><strong>Los Angeles International Airport</strong> (IATA: <strong>LAX</strong>, ICAO: <strong>KLAX</strong>, FAA LID: <strong>LAX</strong>), locally referred to as <strong>LAX</strong> (with each of its letters pronounced individually), is the primary international airport serving Los Angeles, California.</p>
    <address>
        <a class="phone-icon" href="tel:+18554635252" rel="nofollow">+1 (855) 463-5252</a>
    </address>
    <p>LAX is 18 miles (29 km) southwest of Downtown Los Angeles, between the district of Westchester to its immediate north, the city of El Segundo to its immediate south and the city of Inglewood to its immediate east. LAX serves as a hub or focus city for more passenger airlines than any other airport in the United States. It is the only airport that four U.S. legacy carriers (Alaska, American, Delta, and United) have designated as a hub and is a focus city for Air New Zealand, Allegiant Air, Norwegian Air Shuttle, Qantas, Southwest Airlines, Spirit Airlines, and Volaris.</p>
    <p>There are 8 terminals at LAX; arrivals are on the ground floor; departures are on the top floor. Terminal maps can be found on the <a href="https://www.flylax.com/en/lax-terminal-maps">LAX website</a>.</p>
    ...
    <h3>Taxis</h3>
    <p>Taxis can be found curbside on the Lower/Arrival Level islands in front of each terminal under the yellow sign indicating Taxis. Passengers will be presented with a ticket stating typical fares to major destinations. Only authorized taxis with an official seal issued by City of Los Angeles Department of Transportation on each vehicle are permitted in the airport. It is illegal for any transportation services to solicit fares, and travelers using such services do so at their own risk.</p>
    <ul>
        <li>Estimated taxi fare: 49 USD (one way)</li>
        <li>Alternate transportation: ExecuCar; fee: 74 USD (one way) on request</li>
    </ul>

    <h3>Shared Ride Vans</h3>
    <p><a href="https://www.supershuttle.com/">Super Shuttle</a>, a shared ride van company, operates out of LAX and is authorized to serve all Southern California counties. Passengers are encouraged to contact the company first for more information. (Click on the company name above for contact information.) The Super Shuttle vans pick up passengers on the Lower/Arrivals Level in front of each terminal. Please look for signs that read "Shared Ride Vans" at terminal curbside near the exits from baggage claims areas.</p>
    ...
    <p><strong>Hollywood Burbank Airport</strong>, legally <strong>Bob Hope Airport</strong>, (IATA: <strong>BUR</strong>, ICAO: <strong>KBUR</strong>, FAA LID: <strong>BUR</strong>) is a public airport 3 miles (4.8 km) northwest of downtown Burbank, in Los Angeles County, California. The airport is the only airport in the area with a direct rail connection to downtown Los Angeles. Non-stop flights mostly serve cities in the western United States, while JetBlue Airways has daily red-eye flights to New York City and Boston.</p>
    <address>
        <a class="phone-icon" href="tel:+18188408840" rel="nofollow">+1 (818) 840-8840</a>
    </address>
    ...
    <ul>
        <li>Start north on North Hollywood Way.</li>
        <li>Merge onto I-5 South/Golden State Freeway.</li>
        <li>Take the exit toward Los Angeles/CA-110 South.</li>
        <li>Merge onto CA-110.</li>
        <li>Take the exit toward I-5 South.</li>
        <li>Keep right for Temple Street.</li>
        <li>Turn left onto West Temple Street.</li>
        <li>Turn right at the 1st cross street onto North Hope Street.</li>
...
define('PageDescription', "LAX, the Los Angeles International Airport, is 18 miles (30 km) southwest of Downtown Los Angeles. The Hollywood Burbank Airport, legally Bob Hope Airport, is the only airport in the area with a direct rail connection to downtown Los Angeles.");
?>
<script type="application/ld+json">
{
  ...
  "@type": "WebPage",
  "name": "Airports Guide",
  "url": "https://vldb.org/2025/?info-airports-guide",
  ...
  "breadcrumb": {
    ...
    "itemListElement": [{
      ...
      "position": 5,
      "item": {
        "@id": "https://vldb.org/2025/?info-airports-guide",
        "name": "Airports Guide"
      }
    }]
  }
