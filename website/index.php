...
function showSlides(n) {
  ...
  dots[slideIndex-1].className += " active";
    ...
    <title>VLDB 2026 - <?= defined('PageTitle') && PageTitle ? PageTitle : "52nd International Conference on Very Large Data Bases"; ?></title>
    <?php if (defined('PageDescription') && PageDescription) { ?>
        <meta name="description" content="<?= PageDescription; ?>" />
    <? } else { ?>
        <meta name="description" content="The VLDB 2025 conference, will take place in London, United Kingdom, 2025, and will feature research talks, tutorials, demonstrations, and workshops. It will cover issues in data management, database and information systems research. VLDB is a premier annual international forum for data management and database researchers, vendors, practitioners, application developers, and users." />
    <?php } ?>
</head>
<body>
...
<header>
    ...
    <div class="small-header"><figure class="logo"><a href="https://vldb.org/2025/"><img style="max-width: 150px; min-width: 100px;" src="./img/vldb2025_logo_simple.png" alt="VLDB 2026 Boston, USA"></a></figure></div>
    ...
    <section class="carousel<?= $q == 'home' ? '' : ' small'; ?>" data-images='[{"i":"./img/boston/boston-1.jpg","t":"Boston"},{"i":"./img/boston/boston-2.jpg","t":"Boston"}]'>
        <span>52<sup>nd</sup> International Conference on Very Large Data Bases</span>
...
<footer>
    <div>52<sup>nd</sup> International Conference on Very Large Data Bases<br />Boston, MA, USA -- Aug 31 - Sep 4, 2026</div>
    <a class="github no-ext-icon" href="https://github.com/dbogatov/vldb-2026" title="Collaborate on GitHub">
